...
describe('Map', function () {
  ...
  it('sets bounds', function () {
    var bounds = [[0, 0], [2, 2]];
    var component = _react2['default'].createElement(Map, { bounds: bounds });
    var instance = (0, _reactDom.render)(component, document.getElementById('test'));
    var mapLeaflet = instance.leafletElement;
  ...
  it('updates center and zoom props', function () {
    var Component = (function (_React$Component2) {
      ...
      _createClass(Component, [{
        ...
        key: 'render',
        value: function render() {
          return _react2['default'].createElement(Map, { center: this.state.center, ref: 'map', zoom: this.state.zoom });
        }
      }]);
  ...
  it('updates bounds props', function () {
    var Component = (function (_React$Component3) {
      ...
      _createClass(Component, [{
        ...
        key: 'render',
        value: function render() {
          return _react2['default'].createElement(Map, { bounds: this.state.bounds, ref: 'map' });
        }
      }]);
