...
describe('MapComponent', function () {
  ...
  it('unbinds the event', function () {
    ...
    var TestComponent = (function (_React$Component) {
      ...
      function TestComponent() {
        ...
        _get(Object.getPrototypeOf(TestComponent.prototype), 'constructor', this).call(this);
        this.state = { bindEvent: true };
      }

      _createClass(TestComponent, [{
        key: 'dontBind',
        value: function dontBind() {
        ...
        key: 'render',
        value: function render() {
          return this.state.bindEvent ? _react2['default'].createElement(Component, { onClick: callback, ref: 'c' }) : _react2['default'].createElement(Component, { ref: 'c' });
        }
      }]);
  ...
  it('replaces the event', function () {
    ...
    var TestComponent = (function (_React$Component2) {
      ...
      _createClass(TestComponent, [{
        key: 'replaceCallback',
        value: function replaceCallback() {
        ...
        key: 'render',
        value: function render() {
          return _react2['default'].createElement(Component, { onClick: this.state.cb, ref: 'c' });
        }
      }]);
