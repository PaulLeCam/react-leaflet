...
var MapPane = function (_Component) {
  ...
  function MapPane() {
    ...
    var _this = _possibleConstructorReturn(this, (MapPane.__proto__ || Object.getPrototypeOf(MapPane)).call(this, { name: name }));

    _this.state = {
      _isMounted: false
    };

    _this._name = name || (0, _uniqueId3.default)();
    return _this;
  }
  ...
  _createClass(MapPane, [{
    ...
    value: function componentWillUnmount() {
      ...
      if (name) {
        ...
        if ((0, _indexOf3.default)(BLACKLIST, _name)) {
